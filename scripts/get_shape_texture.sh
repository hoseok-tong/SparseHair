...
# MODEL_CKPT="/hdd_sda1/tonghs/workspace/SparseHair/StrandVAE/output/strand_vae/2024-10-18_15-57-46/checkpoint_epoch_1000.pth"  # baseline wo leakyrelu
...
python StrandVAE/get_shape_texture.py \
    --seed $SEED \
