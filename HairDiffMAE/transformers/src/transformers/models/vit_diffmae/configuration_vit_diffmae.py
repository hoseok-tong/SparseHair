...
# class ViTDiffMAEConfig(PretrainedConfig):
#     r"""
#     This is the configuration class to store the configuration of a [`ViTDiffMAEModel`]. It is used to instantiate an ViT
...
#     ```python
#     >>> from transformers import ViTDiffMAEConfig, ViTDiffMAEModel

#     >>> # Initializing a ViT MAE vit-mae-base style configuration
#     >>> configuration = ViTDiffMAEConfig()

#     >>> # Initializing a model (with random weights) from the vit-mae-base style configuration
#     >>> model = ViTDiffMAEModel(configuration)
...
class ViTDiffMAEConfig(PretrainedConfig):
    ...
    def __init__(
        self,
        hidden_size=768,            # 16*16*3
        num_hidden_layers=12,       # 768 = 12*64
        num_attention_heads=12,
        intermediate_size=3072,     # 3072 = 768*4 = 64*48 = 64*12*4 = 1024*3
        hidden_act="gelu",
        hidden_dropout_prob=0.0,
        attention_probs_dropout_prob=0.0,
        initializer_range=0.02,
        layer_norm_eps=1e-12,
        image_size=224,             # 16*14 
        patch_size=16,
        num_channels=3,
        qkv_bias=True,
        decoder_num_attention_heads=16,
...
#     def __init__(
#         self,
#         hidden_size=512,    # 16*16*3=768
#         num_hidden_layers=16,
#         num_attention_heads=16,
#         intermediate_size=2048,     # 768*4
#         hidden_act="gelu",
#         hidden_dropout_prob=0.0,
#         attention_probs_dropout_prob=0.0,
#         initializer_range=0.02,
